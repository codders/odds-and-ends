-- My AwesomeRC. Lives in ~/.config/awesome
...
mychatbox = widget({ type = "textbox", align = "right" })
-- Set the default text in textbox
myclockbox.text = "<b><small> " .. AWESOME_RELEASE .. " </small></b>"
mychatbox.text = "<b><small> Chat goes here </small></b>"
...
awful.hooks.timer.register(60, function ()
    myclockbox.text = os.date(" %Y%m%d %H:%M ")
end)
-- }}}
